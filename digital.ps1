Clear-Host
Write-Host "Digital Forensics | Cheat Detection | Mod Analysis" -ForegroundColor Red
Write-Host "--------------------------------------------------------"
Write-Host "This scanner was developed by: " -ForegroundColor White -NoNewline
Write-Host "ArchiveThomas"
Write-Host "--------------------------------------------------------"
Write-Host "Please only use this detector if you know what you are doing!" -ForegroundColor red
Write-Host "- ArchiveThomas | Developer of Mod analyzers and Cheat Detector" -ForegroundColor DarkGray
Write-Host "--------------------------------------------------------"
Write-Host ""
Write-Host "This tool will scan your Minecraft mods folder for known cheats and unknown mods." -ForegroundColor Yellow
Write-Host "It uses Modrinth and Megabase APIs to verify known mods by their SHA1 hash." -ForegroundColor Yellow
Write-Host "Unknown mods will be scanned for known cheat strings." -ForegroundColor Yellow
Write-Host ""
Write-Host "TO SCREENSHARES - Do not use this tool to falsely accuse others of cheating!" -ForegroundColor Red
Write-Host ""   
Write-Host "--------------------------------------------------------"
Write-Host "Join Digital Forensics Discord: " -ForegroundColor White -NoNewline
Write-Host "https://discord.gg/4by6j9wkFm" -ForegroundColor Cyan
Write-Host "--------------------------------------------------------"
Write-Host ""
